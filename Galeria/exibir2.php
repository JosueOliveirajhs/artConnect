...
<header class="header">
    <nav class="navbar">
    <button onclick="goToHome()"><a href="../index2.php" class="links">Home</a></button>
    <button onclick="openCalendar()">Calendário</button>
    <button onclick="showPlans()">Planos</button>
    <button onclick="aboutUs()"><a href="../index2.php" class="links">Sobre Nós</a></button>
    <button onclick="contactUs()"><a href="../index2.php" class="links">Contato</a></button>
</nav>
<div class="logo">
...
function showPlans() {
    window.location.href = "../planos/previa_pagamento.html";
}
