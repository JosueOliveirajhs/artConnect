...
<header class="header">
    <nav class="navbar">
    <button onclick="goToHome()"><a href="../index_user.php" class="links">Home</a></button>
    <button onclick="openCalendar()">Calendário</button>
    <button onclick="showPlans()">Planos</button>
    <button onclick="aboutUs()"><a href="../index_user.php" class="links">Sobre Nós</a></button>
    <button onclick="contactUs()"><a href="../index_user.php" class="links">Contato</a></button>
</nav>
<div class="logo">
...
function openCalendar() {
    window.location.href = "../mural_user.html"; // Redireciona para a página do calendário
}
